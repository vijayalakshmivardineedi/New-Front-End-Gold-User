...
const Rings = ({ addToWishlist }) => {
  ...
  const renderProductBox = (product) => (
      ...
      <div className="box">
        <Link to={`/Rings/${product._id}`} key={product._id}>
        <div className="img_box">
          ...
          <div className="icon"><Link to={`/Earrings/${product._id}`} key={product._id}>
            <li>
              <BsEye />
            </li>
            </Link>
  ...
  return (
    <div>
      <div className="Banner">
        <img
          style={{ height: "auto"}}
          src="https://static.malabargoldanddiamonds.com/media/catalog/category/diamond-ring-b.jpg"
